...
const TOLL_PLAZAS = [
  ...
  { plaza: 'Changlun',     concession: 'PLUS',   state: 'Kedah',             throughput: 6200,  revenue: 7.4,  change: 2.8 },
  { plaza: 'Kangar Link',  concession: 'PLUS',   state: 'Perlis',            throughput: 2600,  revenue: 2.1,  change: 1.9 },
  { plaza: 'Ipoh Selatan', concession: 'PLUS',   state: 'Perak',             throughput: 8900,  revenue: 10.7, change: -0.8 },
  { plaza: 'Seremban',     concession: 'PLUS',   state: 'Negeri Sembilan',   throughput: 7600,  revenue: 8.9,  change: 3.4 },
  { plaza: 'Ayer Keroh',   concession: 'PLUS',   state: 'Melaka',            throughput: 6400,  revenue: 7.2,  change: 1.6 },
  { plaza: 'Bentong',      concession: 'LITRAK', state: 'Pahang',            throughput: 5800,  revenue: 6.8,  change: -1.1 },
  { plaza: 'Kuantan',      concession: 'SPRINT', state: 'Pahang',            throughput: 5200,  revenue: 6.1,  change: 4.6 },
  { plaza: 'Ajil',         concession: 'PLUS',   state: 'Terengganu',        throughput: 4100,  revenue: 4.8,  change: 2.5 },
  { plaza: 'Kota Bharu',   concession: 'PLUS',   state: 'Kelantan',          throughput: 3900,  revenue: 4.2,  change: -0.4 },
  { plaza: 'Putrajaya',    concession: 'SPRINT', state: 'W.P. Putrajaya',    throughput: 4800,  revenue: 5.5,  change: 1.3 },
  { plaza: 'Kota Kinabalu',concession: 'LITRAK', state: 'Sabah',             throughput: 5700,  revenue: 5.9,  change: 5.1 },
  { plaza: 'Sandakan',     concession: 'SPRINT', state: 'Sabah',             throughput: 3300,  revenue: 3.4,  change: -1.8 },
  { plaza: 'Kuching',      concession: 'PLUS',   state: 'Sarawak',           throughput: 6100,  revenue: 6.3,  change: 3.2 },
  { plaza: 'Miri',         concession: 'LITRAK', state: 'Sarawak',           throughput: 3600,  revenue: 3.8,  change: 0.9 },
  { plaza: 'Labuan Port',  concession: 'LITRAK', state: 'W.P. Labuan',       throughput: 1900,  revenue: 1.6,  change: 2.2 },
];
const CONGESTION_HOTSPOTS = [
  ...
  { corridor: 'E1 — Juru northbound merge',     state: 'Pulau Pinang',      jam: 6.6, avgSpeed: 47 },
  { corridor: 'NSE — Senai Utara',              state: 'Johor',             jam: 6.8, avgSpeed: 47 },
  { corridor: 'E1 — Changlun SB approach',      state: 'Kedah',             jam: 6.2, avgSpeed: 52 },
  { corridor: 'Route 7 — Kangar town link',     state: 'Perlis',            jam: 4.1, avgSpeed: 58 },
  { corridor: 'E2 — Seremban northbound',       state: 'Negeri Sembilan',   jam: 6.5, avgSpeed: 49 },
  { corridor: 'E2 — Ayer Keroh interchange',    state: 'Melaka',            jam: 5.9, avgSpeed: 51 },
  { corridor: 'E8 — Bentong climb',             state: 'Pahang',            jam: 7.1, avgSpeed: 45 },
  { corridor: 'Route 3 — Kuantan bypass',       state: 'Pahang',            jam: 6.4, avgSpeed: 48 },
  { corridor: 'Route 14 — Kuala Terengganu',    state: 'Terengganu',        jam: 5.4, avgSpeed: 54 },
  { corridor: 'Route 8 — Kota Bharu approach',  state: 'Kelantan',          jam: 5.8, avgSpeed: 50 },
  { corridor: 'Persiaran Utara — Precinct 1',   state: 'W.P. Putrajaya',    jam: 4.6, avgSpeed: 56 },
  { corridor: 'Pan Borneo — KK urban approach', state: 'Sabah',             jam: 6.9, avgSpeed: 46 },
  { corridor: 'Route 22 — Sandakan corridor',   state: 'Sabah',             jam: 5.1, avgSpeed: 55 },
  { corridor: 'Pan Borneo — Kuching-Samarahan', state: 'Sarawak',           jam: 7.3, avgSpeed: 43 },
  { corridor: 'Route 1 — Bintulu industrial',   state: 'Sarawak',           jam: 5.6, avgSpeed: 52 },
  { corridor: 'Labuan Ring Road — Port access', state: 'W.P. Labuan',       jam: 3.8, avgSpeed: 60 },
];
